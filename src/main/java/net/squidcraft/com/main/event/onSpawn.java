...
public class onSpawn implements Listener {
  ...
  public void Spawn(EntitySpawnEvent e) {
    ...
    if (!e.getEntity().getType().equals(EntityType.ZOMBIE) && !e.getEntity().getType().equals(EntityType.SKELETON) && !e.getEntity().getType().equals(EntityType.DROPPED_ITEM) && !e.getEntity().getType().equals(EntityType.FALLING_BLOCK) && !e.getEntity().getType().equals(EntityType.ARMOR_STAND))
      e.setCancelled(true); 
  }
}
